...
if [ $# -ne 3 ]; then
    echo
    echo "================================================================================================="
    echo Usage: installManagedProject.sh institution install_dir github_branch
    echo
    echo "e.g. sudo ./installManagedProject.sh pahma pahmaNV pahma_4.0_1 > install.log 2>&1"
    echo
...
if [ -e "/var/www/$2" ]; then
    echo "================================================================================================="
    echo "$2 already exists. cleaning it out..."
    echo "================================================================================================="
    rm -rf /var/www/$2/*
else
    mkdir /var/www/$2
